...
// Cargar el autoloader de Composer si estás usando PhpSpreadsheet vía Composer
...
if (!isset($_SESSION['id_usuario']) || (isset($_SESSION['rol']) && $_SESSION['rol'] != 1)) {
    // No deberías llegar aquí si el botón solo es visible para admins, pero por seguridad
...
try {
    ...
    // Si estás usando IE9 o anterior
    // header('Cache-Control: max-age=1');

    // Si estás usando HTTPS (recomendado)
